...
sealed class SubPriceWithSpecialPriceEntity<T : SubPriceEntity, E : SpecialPriceEntity>(
    ...
    ) : SubPriceWithSpecialPriceEntity<SubPriceEntity.MerchantSubPriceEntity, SpecialPriceEntity.MerchantSpecialPriceEntity>(subPriceEntity, specialPriceEntities)
    ...
    ) : SubPriceWithSpecialPriceEntity<SubPriceEntity.ConsumerSubPriceEntity, SpecialPriceEntity.ConsumerSpecialPriceEntity>(subPriceEntity, specialPriceEntities)
